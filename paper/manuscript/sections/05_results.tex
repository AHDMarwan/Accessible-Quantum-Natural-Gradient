...
The large/deep extension supplies the missing first-order baselines at $(n,L)=(8,3),(10,3),(6,5)$ for SU(2)--Haar on Iris. Table~\ref{tab:large_deep} combines the matched five-seed means. The pooled 15-case loss is $0.1867$ for aligned AQNG, compared with $0.1961$ for random AQNG, $0.2207$ for physical AQNG, $0.2268$ for Adam, $0.3998$ for SGD, and $0.4312$ for full QNG.
...
\node[font=\scriptsize, anchor=south west] at (axis cs:0.7383,0.7165) {order 2};
\node[font=\scriptsize, anchor=south west] at (axis cs:0.3606,0.2373) {order 1};
\node[font=\scriptsize, anchor=south west] at (axis cs:0.7969,0.3615) {order 2};
\end{axis}
\end{tikzpicture}
