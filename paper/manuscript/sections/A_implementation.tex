...
All durable experiment outputs, aggregate tables, configuration records, and checksums are committed under \texttt{results/paper/paper\_scale\_v2/}. The report records the source workflow revisions for both the 470-cell paper-scale campaign and the 15-cell SGD/Adam follow-up.
